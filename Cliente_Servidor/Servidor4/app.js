...
var server_index = 0;
var chosen_server = 0;
var server_ports = [3001, 4001, 5001];
...
io_server.on('connection', function(socket) {
    ...
    socket.on('inic_eleicao', function(port_received) {
        if (port_received == true) {
            ...
            function init_elect() {
                ...
                console.log('Servidor 4 enviou id = ' + id_forward + ' para o servidor ' + server_ports[server_index]);
            }
        }
    });
    ...
    socket.on('election', function(id_received) {
        ...
        function elect() {
            ...
            console.log('Servidor 4 recebeu id = ' + id_received);
            if (id == id_received) {
                elected = id;
