...
var io_client = null;
var server_index = 0;
var server_ports = [5001, 6001, 3001];
...
io_server.on('connection', function(socket) {
    ...
    socket.on('inic_eleicao', function(port_received) {
        if (port_received == true) {
            ...
            function init_elect() {
                ...
                console.log('Servidor 2 enviou id = ' + id_forward + ' para o servidor ' + server_ports[server_index]);
            }
        }
    });
    ...
    socket.on('election', function(id_received) {
        ...
        function elect() {
            console.log('Servidor 2 recebeu id = ' + id_received);
            if (id == id_received) {
                elected = id;
